...
export declare let RadioGroup: (<TTag extends React.ElementType<any> = "div", TType = string>(props: Props<TTag, RadioGroupRenderPropArg<TType>, "value" | "name" | "disabled" | "defaultValue" | "onChange" | "by" | RadioGroupPropsWeControl> & {
    ...
    Label: (<TTag_2 extends React.ElementType<any> = "label">(props: Omit<import('@headlessui/react/dist/types').PropsOf<TTag_2>, ("as" | "children" | "refName" | "className") | "id"> & {
        as?: TTag_2 | undefined;
        ...
        className?: import('@headlessui/react/dist/types').PropsOf<TTag_2>["className"] | ((bag: {}) => string) | undefined;
    } : {}) & {
