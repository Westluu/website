...
export declare let Portal: (<TTag extends React.ElementType<any> = React.ExoticComponent<{
    ...
    Group: (<TTag_1 extends React.ElementType<any> = React.ExoticComponent<{
        children?: React.ReactNode;
    }>>(props: Omit<import('@headlessui/react/dist/types').PropsOf<TTag_1>, "as" | "children" | "refName" | "className"> & {
        as?: TTag_1 | undefined;
        ...
        className?: import('@headlessui/react/dist/types').PropsOf<TTag_1>["className"] | ((bag: GroupRenderPropArg) => string) | undefined;
    } : {}) & {
