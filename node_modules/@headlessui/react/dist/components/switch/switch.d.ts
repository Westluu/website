...
export declare let Switch: (<TTag extends React.ElementType<any> = "button">(props: Props<TTag, SwitchRenderPropArg, "value" | "name" | "onChange" | "checked" | "defaultChecked" | SwitchPropsWeControl> & {
    ...
    Group: typeof Group;
    Label: (<TTag_1 extends React.ElementType<any> = "label">(props: Omit<import('@headlessui/react/dist/types').PropsOf<TTag_1>, ("as" | "children" | "refName" | "className") | "id"> & {
        as?: TTag_1 | undefined;
        children?: React.ReactNode | ((bag: {}) => React.ReactElement<any, string | React.JSXElementConstructor<any>>);
        refName?: string | undefined;
    } & (true extends (import('@headlessui/react/dist/types').PropsOf<TTag_1> extends never ? never : "className" extends keyof import('@headlessui/react/dist/types').PropsOf<TTag_1> ? true : never) ? {
        className?: import('@headlessui/react/dist/types').PropsOf<TTag_1>["className"] | ((bag: {}) => string) | undefined;
    } : {}) & {
