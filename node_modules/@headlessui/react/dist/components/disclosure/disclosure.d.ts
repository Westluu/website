...
export declare let Disclosure: (<TTag extends React.ElementType<any> = React.ExoticComponent<{
...
}>>(props: Omit<import('@headlessui/react/dist/types').PropsOf<TTag>, "as" | "children" | "refName" | "className"> & {
    as?: TTag | undefined;
    children?: React.ReactNode | ((bag: DisclosureRenderPropArg) => React.ReactElement<any, string | React.JSXElementConstructor<any>>);
    refName?: string | undefined;
} & (true extends (import('@headlessui/react/dist/types').PropsOf<TTag> extends never ? never : "className" extends keyof import('@headlessui/react/dist/types').PropsOf<TTag> ? true : never) ? {
    className?: import('@headlessui/react/dist/types').PropsOf<TTag>["className"] | ((bag: DisclosureRenderPropArg) => string) | undefined;
} : {}) & {
    ...
    Panel: (<TTag_2 extends React.ElementType<any> = "div">(props: Omit<import('@headlessui/react/dist/types').PropsOf<TTag_2>, ("as" | "children" | "refName" | "className") | "id"> & {
        as?: TTag_2 | undefined;
        children?: React.ReactNode | ((bag: PanelRenderPropArg) => React.ReactElement<any, string | React.JSXElementConstructor<any>>);
        refName?: string | undefined;
    } & (true extends (import('@headlessui/react/dist/types').PropsOf<TTag_2> extends never ? never : "className" extends keyof import('@headlessui/react/dist/types').PropsOf<TTag_2> ? true : never) ? {
        className?: import('@headlessui/react/dist/types').PropsOf<TTag_2>["className"] | ((bag: PanelRenderPropArg) => string) | undefined;
    } : {}) & (({
        static?: undefined;
    } & {
