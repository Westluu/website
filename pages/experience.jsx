...
export default function Home() {
  const { data: _projects } = swr('/api/repos');
  const projects = _projects ? _projects : null;

  return (
    <>
      <div className="py-20">
        <p className="text-3xl text-white font-semibold text-center">Experience</p>
        <p className="text-xl text-white/50 font-normal text-center mb-5">Test The projects that I am actively working on are in this field.</p>
